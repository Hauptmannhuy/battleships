...
import { renderBoard, createBoard, gameOverDeclaration, displaySelector, removeHighlights } from "./renderBoard";
      ...
      function onMouseMove(ev){
        ...
        if (elementUnderShip.hasAttribute('coord')){
          ...
          if (lastElement != elementUnderShip ){
            ...
            if (unprocessedCoords.every((el) => !el.classList.contains('highlight'))){ // check for overlap
